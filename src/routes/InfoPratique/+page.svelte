	...
	<Tabs.Root value="Horaire" class="w-11/12 md:w-5/6 flex flex-col m-4">
		...
		<Tabs.Content value="Localisation">
			...
			<div class="flex flex-col items-center justify-center bg-gray-100 rounded-md p-4 gap-8">
				...
				<p class="text-justify m-2">
					Dès les entrées de La Grigonnais, l'entrée du festival est indiquée par des panneaux de
					signalétique. Un grand parking est mis à disposition des festivaliers qui comptent
