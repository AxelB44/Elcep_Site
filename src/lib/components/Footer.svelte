...
<footer class="flex flex-col justify-center bg-neutral-900 items-center p-2">
	<div class="flex">
	...
	<h3 class="text-white">
		Contact : <a href="mailto:communication.elcep@gmail.com" class="hover:text-red-500"
			>communication.elcep@gmail.com</a
		>
	</h3>
	<h3 class="text-white">
		© Copyright par <a
			href="https://www.lagrigonnais.fr/les-saltimbanques/"
			target="_blank"
			class="hover:text-red-500">Les Saltimbanques</a
		>
	</h3>
</footer>
